...
As for converting textures, sure VTFEdit works, but is slow when it comes to batch-doing stuff, and I don't move any setting, I always use DXT5 for the formats and that's it.

Also, I don't want to depend on online tools for this.

# Do you have any suggestion or bug report?
You can contact me on Discord `@Clb184`. 
If you have any problems, you can look at the console and send me a screenshot of it. If the program closes, you can open a console (Like `cmd`) in the folder containing `vtfworkbench` to retain the console output.
